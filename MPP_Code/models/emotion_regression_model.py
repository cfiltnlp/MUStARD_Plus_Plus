...
We have used Tanh As Output layer

"""


class Speaker_Independent_Triple_Mode_with_Context(nn.Module):
    def __init__(self, input_embedding_A=2048, input_embedding_B=1024, input_embedding_C=291, shared_embedding=1024, projection_embedding=512, dropout=0.5, num_classes=2):
...
class Speaker_Dependent_Triple_Mode_with_Context(nn.Module):
    def __init__(self, n_speaker=24, input_embedding_A=2048, input_embedding_B=1024, input_embedding_C=291, shared_embedding=1024, projection_embedding=512, dropout=0.5, num_classes=2):
...
class Speaker_Dependent_Dual_Mode_with_Context(nn.Module):
    def __init__(self, n_speaker=24, input_embedding_A=1024, input_embedding_B=2048, shared_embedding=1024, projection_embedding=512, dropout=0.5, num_classes=2):
...
class Speaker_Dependent_Single_Mode_with_Context(nn.Module):
    def __init__(self, n_speaker=24, input_embedding_A=1024, shared_embedding=1024, projection_embedding=512, dropout=0.5, num_classes=2):
